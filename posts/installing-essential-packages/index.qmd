...
I extracted some data from NHANES website (I used this data for a actual study). I will use this data for future tutorial. Please check if you can download it.
